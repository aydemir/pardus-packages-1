...
# coding=UTF-8
#
# Generated by pykdeuic4 from gui/ui/packagecollection.ui on Mon Oct 22 15:18:28 2012
#
...
class Ui_PackageCollectionDialog(object):
    ...
    def retranslateUi(self, PackageCollectionDialog):
        PackageCollectionDialog.setWindowTitle(kdecore.i18n("Dialog"))
        self.titleLabel.setText(kdecore.i18n("Title:"))
        self.descriptionLabel.setText(kdecore.i18n("Description:"))
        self.packagesButton.setText(kdecore.i18n("Packages"))
        self.icon.setText(kdecore.i18n("No Icon"))
        self.selectIcon.setToolTip(kdecore.i18n("Select Photo"))
        self.clearIcon.setToolTip(kdecore.i18n("Clear Photo"))
